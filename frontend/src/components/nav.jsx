        ...
        <section>
          ...
          <Navbar className="navbar-dark bg-default" expand="lg">
            <Container>
              ...
              <Collapse navbar toggler="#navbar-default">
          ...
          <Navbar className="navbar-dark bg-primary mt-4" expand="lg">
            <Container>
              ...
              <Collapse navbar toggler="#navbar-primary">
                <div className="navbar-collapse-header">
                  <Row>
                    <Col className="collapse-brand" xs="6">
                      <Link to="/">
          ...
          <Navbar className="navbar-dark bg-success mt-4" expand="lg">
            <Container>
              ...
              <Collapse navbar toggler="#navbar-success">
                <div className="navbar-collapse-header">
                  <Row>
                    <Col className="collapse-brand" xs="6">
                      <Link to="/">
          ...
          <Navbar className="navbar-dark bg-danger mt-4" expand="lg">
            <Container>
              ...
              <Collapse navbar toggler="#navbar-danger">
                <div className="navbar-collapse-header">
                  <Row>
                    <Col className="collapse-brand" xs="6">
                      <Link to="/">
          ...
          <Navbar className="navbar-dark bg-warning mt-4" expand="lg">
            <Container>
              ...
              <Collapse navbar toggler="#navbar-warning">
                <div className="navbar-collapse-header">
                  <Row>
                    <Col className="collapse-brand" xs="6">
                      <Link to="/">
          ...
          <Navbar className="navbar-dark bg-info mt-4" expand="lg">
            <Container>
              ...
              <Collapse navbar toggler="#navbar-info">
                <div className="navbar-collapse-header">
